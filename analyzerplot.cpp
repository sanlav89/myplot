...
AnalyzerPlot::AnalyzerPlot(const enpoly_t &enpoly, QWidget *parent)
    : QwtPlot(parent)
{
    // Init energy scale
...
void AnalyzerPlot::updateSpectrum(const spectrum_t &spectrum)
{
...
void AnalyzerPlot::updateActivities(const activities_t &activities)
{
    replot();
}

void AnalyzerPlot::updateNuclides(const nuclideid_t &nuclides)
{
    replot();
}

void AnalyzerPlot::updateEnergyScale(const enpoly_t &enpoly)
{
    auto n = 1;
